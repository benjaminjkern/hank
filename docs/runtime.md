...
| [`find_companies`](../src/server/agent/tools/registry/findCompanies.ts) | The discovery arm (`entryTarget: {kind:"discovery", direction}`), which opens the discovery panel. |
