...
| [`commit_discovery`](../src/server/agent/tools/registry/commitDiscovery.ts) | The discovery-commit arm (`entryTarget: {kind:"discovery_commit"}`) — adds the ADD-marked companies, records the PASSes. The second handoff that also writes. |
