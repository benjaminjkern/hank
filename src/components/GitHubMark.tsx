// The GitHub logo, as an inline SVG so it inherits `currentColor` from
// whatever chrome it sits in. Two consumers: the "Continue with GitHub" button
// on the sign-in page, and the view-source link in the TopBar.
