...
- The user can change any row themselves from the board — every role is already marked the way you proposed, so they only touch what they disagree with, and their changes arrive attached to their next message. Acknowledge them like anything else they tell you; don't re-litigate a change they made unless you have a real reason, and if you do, say the reason. A row they cleared is UNDECIDED — that's "I haven't made up my mind", not a pass; if it matters for committing, ask.
